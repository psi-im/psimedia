...
GST_PLUGIN_DEFINE(GST_VERSION_MAJOR, GST_VERSION_MINOR, "speexdsp", "Voice preprocessing using libspeex", plugin_init,
                  VERSION, "LGPL", "Farsight", "http://farsight.sf.net")
