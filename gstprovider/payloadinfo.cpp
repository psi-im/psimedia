...
GstStructure *payloadInfoToStructure(const PPayloadInfo &info, const QString &media)
{
...

    {
        ...
        // GStreamer depayloaders advertise canonical upper-case names
        // (e.g. OPUS, VP8, PCMU). Normalize signaling input before
        // constructing application/x-rtp caps so peers using "opus"
        // interoperate with rtpopusdepay.
